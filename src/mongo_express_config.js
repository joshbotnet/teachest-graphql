...
if (process.env.VCAP_SERVICES) {
  ...
  mongo = {
    db:       'teachest-db',
    host:     'ds133918-a0.mlab.com',
    password: 'TCdbAdmin123123!',
    port:     33918,
    ssl:      false,
    url:      'mongodb://teachest-db-admin:TCdbAdmin123123!@ds133918-a0.mlab.com:33918,ds133918-a1.mlab.com:33918/teachest-db?replicaSet=rs-ds133918',
    username: 'teachest-db-admin',
  };
}

/*
mongodb://teachest-db-admin:TCdbAdmin123123!
@ds133918-a0.mlab.com:33918,
ds133918-a1.mlab.com:33918/
teachest-db?replicaSet=rs-ds133918
*/
...
module.exports = {
  mongodb: {
    ...
    adminUsername: process.env.ME_CONFIG_MONGODB_ADMINUSERNAME || 'joshbot',
    adminPassword: process.env.ME_CONFIG_MONGODB_ADMINPASSWORD || 'jm101010',
  ...
  site: {
    ...
    host:             process.env.VCAP_APP_HOST                 || 'mainbox.io',
  ...
  useBasicAuth: process.env.ME_CONFIG_BASICAUTH_USERNAME !== 'joshbot',

  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'joshbot',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'jm101010',
  },
